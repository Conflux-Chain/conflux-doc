...
cfx.wallet.addPrivateKey(PRIVATE_KEY)
const sender = '0x1Ceb7B1c5252aE3EAaf19d3a785CfBEA48cc37f7' // address of PRIVATE_KEY
...
```javascript
let txParams = {
  from: sender, // from is address of PRIVATE_KEY and will sign this transaction
  // nonce 
  // gasPrice
  // gas
