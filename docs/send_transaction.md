...
const receiver = 'cfx:type.user:00d2z01m2g4p77n6mddvtaw2k43622daamm1867uk6'
```
...
```
curl -X POST --data '{"jsonrpc":"2.0","method":"cfx_getBalance","params":["cfx:type.user:00d2z01m2g4p77n6mddvtaw2k43622daamm1867uk6"],"id":1}' -H "Content-Type: application/json" https://test.confluxrpc.org
```

And compare the result with `value + gas * gasPrice + storage_limit * (10^18/1024)`.

```
curl -X POST --data '{"jsonrpc":"2.0","method":"cfx_getNextNonce","params":["cfx:type.user:00d2z01m2g4p77n6mddvtaw2k43622daamm1867uk6"],"id":1}' -H "Content-Type: application/json" https://test.confluxrpc.org
```
